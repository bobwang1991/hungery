<template>
  <div ref="sellerWrapper" class="seller-wrapper">
      ...
      <div class="info">
        ...
        <div class="remark">
          ...
          <div class="block">
            <h2>平均配送时间</h2>
            <div class="content">
              <span class="num">{{datas.seller.deliveryTime}}</span>
              分钟
            </div>
          </div>
        </div>
...
<script>
  ...
  import Scrol from 'better-scroll'
  ...
  export default {
    ...
    mounted () {
      ...
      new Scrol(this.$refs['sellerWrapper'], {
        click: true
      })
    },
    components: {
