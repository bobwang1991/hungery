    ...
    <div class="ratings-content">
      <div class="info">
        <div class="mark">
          ...
          <div class="contrast">高于周围商家{{datas.seller.rankRate}}%</div>
        </div>
        <div class="stars">
            ...
            <li class="evel" v-for="item in comment">
              ...
              <div class="content">
                ...
                <div class="star-wrapper">
                  ...
                  <span class="deliverTime">{{item.deliverTime}}分钟送达</span>
                </div>
  ...
  export default {
    ...
    mounted () {
      axios.get('../static/data.json').then(res => {
        // 注册了$nextTick => 更新了dom => 触发了$nextTick => new滚动 => 计算属性里的执行 => 更新dom
